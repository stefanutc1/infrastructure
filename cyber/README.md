...
| :--- | :--- | :--- | :--- | :--- | :--- |
| [`SEC-2026-ECOM-005`](mediagalaxy-ecommerce-fraud-forensics/README.md) | **Media Galaxy Brand Impersonation** | Yunnan, China (`yiyangsaas.com`) | Sponsored TikTok Ad Campaigns | Debit card theft (~21 EUR), secondary ATO lures | Mitigated; DNSC & Cloudflare filed; OPNsense sinkhole |
...
- **Key Artifacts:** 24 forensic screenshots, ReportLab PDF generation script, Suricata IDS rules, multi-agency disclosure filings (DNSC, Cloudflare, Google Safe Browsing, Altex/Media Galaxy).
