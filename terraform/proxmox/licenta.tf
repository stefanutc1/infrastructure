...
module "lxc_paymentgateway_licenta" {
  source       = "../modules/proxmox_lxc"
  target_node  = var.primary_node
  vmid         = 312
...
module "vm_swift_jumpbox_licenta" {
  source       = "../modules/proxmox_vm"
  target_node  = var.primary_node
  vmid         = 313
