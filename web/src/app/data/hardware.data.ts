...
export const HARDWARE_NODES: HardwareNode[] = [
  {
    ...
    role: 'Primary x86_64 virtualization hypervisor running the perimeter OPNsense firewall, active production LXCs (100–107), Parrot Security VM 300, and dedicated GPU AI inference workloads.',
    roleRo: 'Hypervisor primar de virtualizare x86_64 ce rulează firewall-ul perimetral OPNsense, containerele LXC de producție (100–107), VM-ul de securitate Parrot 300 și inferența AI accelerată pe GPU.',
    cpu: 'Intel Core i3-10100F (4 Cores / 8 Threads @ 4.30 GHz Turbo)',
    gpu: 'NVIDIA GeForce GTX 1050 Ti (4GB VRAM · PCIe Passthrough to Ollama CT 103)',
    ...
    status: 'OPERATIONAL',
    tags: ['Primary Hypervisor', 'x86_64 Bare-Metal', 'ZRAM lz4 (6.0GB)', 'PCIe GPU Passthrough', 'VirtIO Ballooning', 'Enterprise LXC Fleet'],
    tagsRo: ['Hypervisor Primar', 'x86_64 Bare-Metal', 'ZRAM lz4 (6.0GB)', 'GPU PCIe Passthrough', 'Balonare VirtIO', 'Flotă LXC Enterprise'],
    ballooningTable: [
      { 
        vmid: 200, 
        name: 'opnsense', 
    ...
    workloads: [
      ...
      'CT 101: n8n Workflow Automation (384 MB · Low-Code SOAR & Event Webhooks)',
      'CT 102: Scrutiny S.M.A.R.T. Monitor (128 MB · Storage Health & Drive Telemetry)',
      'CT 103: Ollama GPU LLM Runtime (2048 MB · PCIe Passthrough NVIDIA GTX 1050 Ti)',
      'CT 104: Uptime Kuma Health Monitor (128 MB · High-Frequency Endpoint Status)',
      'CT 105: Monitoring Stack (256 MB · Prometheus TSDB & Grafana Dashboards)',
      'CT 106: OWASP Pentest Target Lab (512 MB · Juice Shop Web Security Environment)',
      'CT 107: Wazuh SIEM / XDR Manager (6144 MB · OpenSearch 4GB Heap, Manager, Dashboard)'
    ]
  },
  {
    id: 'node2-omv',
